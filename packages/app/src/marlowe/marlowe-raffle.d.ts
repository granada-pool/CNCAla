...
type InitializationError = HookError<
	| "Setup"
	| "FetchPayoutUTxOError"
	| "FindRoleTokenUTxOError"
	| "PayoutUTxOStatusCheckError"
	| "PayoutUTxOAlreadySpentError"
>;

type WithdrawalError = HookError<
...
export function useWithdrawal(props: Props): {
	status: HookStatus;
	reset: (props: Props) => void;
};
