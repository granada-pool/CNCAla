...
const loading = /* #__PURE__ */ (() => {
  ...
  return x => {
    ...
    return () => {
      const a$p = $1();
      return (() => {
        const $2 = Web$dHTML$dHTMLImageElement$dLaziness.parse(a$p);
        if ($2.tag === "Nothing") { return Web$dHTML$dHTMLImageElement$dLaziness.Eager; }
...
const decoding = /* #__PURE__ */ (() => {
  ...
  return x => {
    ...
    return () => {
      const a$p = $1();
      return (() => {
        const $2 = Web$dHTML$dHTMLImageElement$dDecodingHint.parse(a$p);
        if ($2.tag === "Nothing") { return Web$dHTML$dHTMLImageElement$dDecodingHint.Auto; }
        if ($2.tag === "Just") { return $2._1; }
        $runtime.fail();
      })();
    };
  ...
  return x => {
    ...
    return () => {
      ...
      return (() => {
        ...
        if ($2.tag === "Just") { return Web$dHTML$dHTMLImageElement$dCORSMode.parse($2._1); }
