...
const number = /* #__PURE__ */ (() => {
  const $0 = Parsing$dCombinators.choice(Data$dFoldable.foldableArray)([
    (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => Parsing$dString.string("Infinity")(
      ...
      lift1,
      $$throw,
      (state2, a) => more(v2$1 => more(v3 => more(v4 => done(state2, Data$dNumber.infinity))))
    ))),
    (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => Parsing$dString.string("+Infinity")(
      state1,
      more,
    ...
    (() => {
      ...
      return (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => Parsing$dString.string("-Infinity")(
        ...
        lift1,
        $$throw,
        (state2, a) => more(v2$1 => more(v3 => more(v4 => done(state2, $0))))
      )));
    })(),
    (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => Parsing$dString.string("NaN")(
      ...
      lift1,
      $$throw,
      (state2, a) => more(v2$1 => more(v3 => more(v4 => done(state2, Data$dNumber.nan))))
    ))),
    (v1, $0, $1, $2, $3) => {
      const $4 = v1._3;
      const $5 = v1._2;
      return $0(v1$1 => numberRegex(
        ...
        (state2, a) => $0(v2 => {
          ...
          return (() => {
            ...
            $runtime.fail();
          })()(state2, $0, $1, (v2$1, $6) => $2(Parsing.$ParseState(v2$1._1, v2$1._2, $4), Parsing.$ParseError($6._1, $5)), $3);
        })
      ));
    }
  ]);
  ...
  return $0(v1$1 => {
    ...
    return $0(v3 => intDecimalRegex(
      ...
      (v4, $8) => {
        const $9 = v4._3;
        return $0(v5 => {
          if ($9) { return $2(Parsing.$ParseState(v4._1, v4._2, $4), Parsing.$ParseError($8._1, $5)); }
          return Parsing.fail("Expected Int")(
            v1,
            $0,
            $1,
            (v2, $10) => $2(Parsing.$ParseState(v2._1, v2._2, $4), Parsing.$ParseError($10._1, $5)),
            (state2, a) => $0(v2 => {
              ...
              return (() => {
                ...
                if (v.tag === "Just") {
                  const $10 = v._1;
                  return (state1, v$1, v1$2, v2$1, done) => done(state1, $10);
                }
                $runtime.fail();
              })()(state2, $0, $1, (v2$1, $10) => $2(Parsing.$ParseState(v2$1._1, v2$1._2, $4), Parsing.$ParseError($10._1, $5)), $3);
            })
          );
        });
      },
      (state2, a) => $0(v2 => {
        ...
        return (() => {
          ...
          if (v.tag === "Just") {
            const $8 = v._1;
            return (state1, v$1, v1$2, v2$1, done) => done(state1, $8);
          }
          $runtime.fail();
        })()(state2, $0, $1, (v2$1, $8) => $2(Parsing.$ParseState(v2$1._1, v2$1._2, $4), Parsing.$ParseError($8._1, $5)), $3);
      })
    ));
  });
};
