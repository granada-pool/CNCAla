...
const parseErrorHuman = input => contextSize => v => {
  ...
  if (bestPosBefore >= 0) {
    if (bestPosAfter <= lineLength) {
      return [
        ...
        Data$dString$dCommon.joinWith("")(Data$dArray.replicate(lineIndex - bestPosBefore | 0)(" ")) + "▼",
    ...
    return [
      v._1 + " at position index:" + Data$dShow.showIntImpl($0) + " (line:" + Data$dShow.showIntImpl(v._2.line) + ", column:" + Data$dShow.showIntImpl(v._2.column) + ")",
      Data$dString$dCommon.joinWith("")(Data$dArray.replicate(lineIndex - max(0)(lineLength - contextSize | 0) | 0)(" ")) + "▼",
  ...
  return [
    v._1 + " at position index:" + Data$dShow.showIntImpl($0) + " (line:" + Data$dShow.showIntImpl(v._2.line) + ", column:" + Data$dShow.showIntImpl(v._2.column) + ")",
    Data$dString$dCommon.joinWith("")(Data$dArray.replicate(lineIndex - 0 | 0)(" ")) + "▼",
...
const match = p => (state1, more, lift1, $$throw, done) => more(v1 => Parsing.getParserT(
  ...
  (state2, a) => more(v2 => {
    ...
    return more(v1$1 => p(
      ...
      lift1,
      $$throw,
      (state2$1, a$1) => more(v2$1 => more(v1$2 => Parsing.getParserT(
        state2$1,
        more,
        lift1,
        $$throw,
    ...
    return Data$dEither.$Either(
      ...
      (() => {
        ...
        return consumeWith(input => {
          ...
          if (
            $2.tag === "Just" && (() => {
              const $3 = Data$dArray.index($2._1)(0);
              if ($3.tag === "Just") { return $3._1.tag === "Just"; }
              $runtime.fail();
            })()
          ) {
            return Data$dEither.$Either(
    ...
    return more(v1$1 => {
      const loop = (state2$1, arg, gas) => {
        const $1 = (state3, step) => {
          ...
          if (step.tag === "Done") {
            const $1 = step._1;
            return more(v2$1 => done(
              state3,
              Data$dTuple.$Tuple(Data$dString$dCodeUnits.take(Data$dString$dCodeUnits.length($0) - Data$dString$dCodeUnits.length($1._1) | 0)($0), $1._2)
            ));
          }
          $runtime.fail();
        };
        ...
        return more(v3 => {
          const $4 = (v4, $4) => {
            ...
            return more(v5 => {
              ...
              return more(v1$2 => anyCodePoint(state2$1, more, lift1, $$throw, (state2$2, a$1) => more(v2$1 => $1(state2$2, Control$dMonad$dRec$dClass.$Step("Loop", arg)))));
            });
          };
            ...
            (state2$2, a$1) => more(v2$1 => {
              ...
              return more(v1$3 => {
                ...
                return p(
                  ...
                  more,
                  lift1,
                  (v2$2, $7) => $4(Parsing.$ParseState(v2$2._1, v2$2._2, $6), $7),
                  (state2$3, a$2) => more(v2$2 => $1(state2$3, Control$dMonad$dRec$dClass.$Step("Done", Data$dTuple.$Tuple($5, a$2))))
                );
              });
            })
          ));
