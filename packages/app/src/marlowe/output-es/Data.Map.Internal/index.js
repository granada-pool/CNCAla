...
const showTree = dictShow => dictShow1 => v => {
  ...
  if (v.tag === "Two") {
    return "Two (" + showTree(dictShow)(dictShow1)(v._1) + ") (" + dictShow.show(v._2) + ") (" + dictShow1.show(v._3) + ") (" + showTree(dictShow)(dictShow1)(v._4) + ")";
  }
  if (v.tag === "Three") {
    return "Three (" + showTree(dictShow)(dictShow1)(v._1) + ") (" + dictShow.show(v._2) + ") (" + dictShow1.show(v._3) + ") (" + showTree(dictShow)(dictShow1)(v._4) + ") (" + dictShow.show(v._5) + ") (" + dictShow1.show(v._6) + ") (" + showTree(dictShow)(dictShow1)(v._7) + ")";
  }
  $runtime.fail();
};
...
const lookupLE = dictOrd => k => {
  const go = v => {
    ...
    if (v.tag === "Two") {
      ...
      if (v2 === "EQ") { return Data$dMaybe.$Maybe("Just", {key: v._2, value: v._3}); }
      if (v2 === "GT") {
        return Data$dMaybe.$Maybe(
          "Just",
          (() => {
            const $0 = go(v._4);
            if ($0.tag === "Nothing") { return {key: v._2, value: v._3}; }
            if ($0.tag === "Just") { return $0._1; }
            $runtime.fail();
          })()
        );
      }
      if (v2 === "LT") { return go(v._1); }
      $runtime.fail();
    }
    if (v.tag === "Three") {
      const v3 = dictOrd.compare(k)(v._5);
      if (v3 === "EQ") { return Data$dMaybe.$Maybe("Just", {key: v._5, value: v._6}); }
      if (v3 === "GT") {
        return Data$dMaybe.$Maybe(
          "Just",
          (() => {
            const $0 = go(v._7);
            if ($0.tag === "Nothing") { return {key: v._5, value: v._6}; }
            if ($0.tag === "Just") { return $0._1; }
            $runtime.fail();
          })()
        );
      }
      if (v3 === "LT") { return go($$$Map("Two", v._1, v._2, v._3, v._4)); }
    }
    $runtime.fail();
  };
  return go;
...
const lookupGE = dictOrd => k => {
  const go = v => {
    ...
    if (v.tag === "Two") {
      ...
      if (v2 === "GT") { return go(v._4); }
      $runtime.fail();
    }
    if (v.tag === "Three") {
      const v3 = dictOrd.compare(k)(v._2);
      if (v3 === "EQ") { return Data$dMaybe.$Maybe("Just", {key: v._2, value: v._3}); }
      if (v3 === "LT") {
        return Data$dMaybe.$Maybe(
          "Just",
          (() => {
      ...
      if (v3 === "GT") { return go($$$Map("Two", v._4, v._5, v._6, v._7)); }
    }
    $runtime.fail();
  };
  return go;
...
const isSubmap = dictOrd => dictEq => m1 => m2 => all(v => {
  const $0 = lookup(dictOrd)(v._1)(m2);
  if ($0.tag === "Nothing") { return false; }
  return $0.tag === "Just" && dictEq.eq($0._1)(v._2);
        ...
        if (tree.tag === "Leaf") {
          if (ctxs._1.tag === "TwoLeft") {
            if (ctxs._1._3.tag === "Leaf") {
              up$c = false;
              up$r = fromZipper(dictOrd)($0)($$$Map("Two", Leaf, ctxs._1._1, ctxs._1._2, Leaf));
              continue;
            }
          ...
          if (ctxs._1.tag === "TwoRight") {
            if (ctxs._1._1.tag === "Leaf") {
              up$c = false;
              up$r = fromZipper(dictOrd)($0)($$$Map("Two", Leaf, ctxs._1._2, ctxs._1._3, Leaf));
              continue;
            }
          ...
          if (ctxs._1.tag === "ThreeLeft") {
            if (ctxs._1._6.tag === "Leaf" && ctxs._1._3.tag === "Leaf") {
              up$c = false;
              up$r = fromZipper(dictOrd)($0)($$$Map("Three", Leaf, ctxs._1._1, ctxs._1._2, Leaf, ctxs._1._4, ctxs._1._5, Leaf));
              continue;
            }
            if (ctxs._1._3.tag === "Two") {
              up$c = false;
          ...
          if (ctxs._1.tag === "ThreeMiddle") {
            if (ctxs._1._1.tag === "Leaf") {
              if (ctxs._1._6.tag === "Leaf") {
                up$c = false;
                up$r = fromZipper(dictOrd)($0)($$$Map("Three", Leaf, ctxs._1._2, ctxs._1._3, Leaf, ctxs._1._4, ctxs._1._5, Leaf));
                continue;
              }
          ...
          if (ctxs._1.tag === "ThreeRight") {
            if (ctxs._1._1.tag === "Leaf" && ctxs._1._4.tag === "Leaf") {
              up$c = false;
              up$r = fromZipper(dictOrd)($0)($$$Map("Three", Leaf, ctxs._1._2, ctxs._1._3, Leaf, ctxs._1._5, ctxs._1._6, Leaf));
              continue;
            }
...
const foldableMap = {
  ...
  foldMap: dictMonoid => {
    ...
    return f => m => {
      if (m.tag === "Leaf") { return mempty; }
      if (m.tag === "Two") { return $0.append(foldableMap.foldMap(dictMonoid)(f)(m._1))($0.append(f(m._3))(foldableMap.foldMap(dictMonoid)(f)(m._4))); }
      if (m.tag === "Three") {
...
const foldSubmapBy = dictOrd => appendFn => memptyValue => kmin => kmax => f => {
  ...
  const go = v => {
    ...
    if (v.tag === "Three") {
      return appendFn(appendFn(appendFn(appendFn(tooSmall(v._2) ? memptyValue : go(v._1))(inBounds(v._2) ? f(v._2)(v._3) : memptyValue))(tooSmall(v._5) || tooLarge(v._2)
        ? memptyValue
        : go(v._4)))(inBounds(v._5) ? f(v._5)(v._6) : memptyValue))(tooLarge(v._5) ? memptyValue : go(v._7));
    }
    $runtime.fail();
  };
  return go;
...
const lookupGT = dictOrd => k => {
  const go = v => {
    ...
    if (v.tag === "Three") {
      const v3 = dictOrd.compare(k)(v._2);
      if (v3 === "EQ") { return findMin($$$Map("Two", v._4, v._5, v._6, v._7)); }
      if (v3 === "LT") {
        return Data$dMaybe.$Maybe(
          "Just",
          (() => {
...
const lookupLT = dictOrd => k => {
  const go = v => {
    ...
    if (v.tag === "Three") {
      const v3 = dictOrd.compare(k)(v._5);
      if (v3 === "EQ") { return findMax($$$Map("Two", v._1, v._2, v._3, v._4)); }
      if (v3 === "GT") {
        return Data$dMaybe.$Maybe(
          "Just",
          (() => {
...
const ordMap = dictOrd => {
  ...
  return dictOrd1 => {
    ...
    return {
      compare: m1 => m2 => Data$dOrd.ordArray(ordTuple(dictOrd1)).compare(toUnfoldable(Data$dUnfoldable.unfoldableArray)(m1))(toUnfoldable(Data$dUnfoldable.unfoldableArray)(m2)),
      Eq0: () => eqMap2
    };
  };
};
...
const filterWithKey = dictOrd => {
  ...
  return predicate => {
    const $0 = Data$dList$dLazy.filter(v => predicate(v._1)(v._2));
    return x => fromFoldable1($0(toUnfoldable(Data$dList$dLazy$dTypes.unfoldableList)(x)));
  };
};
...
const fromFoldableWith = dictOrd => dictFoldable => f => dictFoldable.foldl(m => v => {
  const $0 = v._2;
  return alter(dictOrd)(v1 => {
    if (v1.tag === "Just") { return Data$dMaybe.$Maybe("Just", f($0)(v1._1)); }
...
const semigroupMap = () => dictOrd => dictSemigroup => {
  ...
  return {append: l => r => unionWith(dictOrd)(append2)(l)(r)};
};
const monoidSemigroupMap = () => dictOrd => dictSemigroup => {
  const append2 = dictSemigroup.append;
  const semigroupMap3 = {append: l => r => unionWith(dictOrd)(append2)(l)(r)};
