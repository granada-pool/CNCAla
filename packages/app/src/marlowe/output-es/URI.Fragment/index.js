...
const unsafeFromString = Fragment;
const toString = v => {
  const $0 = JSURI._decodeURIComponent(v$1 => Data$dMaybe.Nothing, Data$dMaybe.Just, v);
  if ($0.tag === "Just") { return $0._1; }
  $runtime.fail();
};
const showFragment = {show: v => "(Fragment.unsafeFromString " + Data$dShow.showStringImpl(v) + ")"};
const semigroupFragment = Data$dSemigroup.semigroupString;
const print = v => "#" + v;
const ordFragment = Data$dOrd.ordString;
const monoidFragment = Data$dMonoid.monoidString;
const fragmentChar = /* #__PURE__ */ (() => {
...
const fromString = x => URI$dCommon.printEncoded(fragmentChar)(x);
  ...
  const $1 = Data$dList.manyRec(Parsing.monadRecParserT)(Parsing.alternativeParserT)((v2, $1, $2, $3, $4) => {
    ...
    return $1(v3 => URI$dCommon.pctEncoded(
      ...
      (v4, $7) => {
        ...
        return $1(v5 => {
          if ($8) { return $3(v4, $7); }
          return $1(v1 => fragmentChar(v2, $1, $2, $3, (state2, a) => $1(v2$1 => $4(state2, Data$dString$dCodeUnits.singleton(a)))));
        });
      },
      $4
    ));
...
const eqFragment = Data$dEq.eqString;
export {Fragment, eqFragment, fragmentChar, fromString, monoidFragment, ordFragment, parser, print, semigroupFragment, showFragment, toString, unsafeFromString, unsafeToString};
