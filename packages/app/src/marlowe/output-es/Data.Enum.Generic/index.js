  ...
  return dictGenericBoundedEnum1 => {
    ...
    return {
      ...
      "genericToEnum'": n => Data$dMaybe.applyMaybe.apply((() => {
        ...
        if ($0.tag === "Just") { return Data$dMaybe.$Maybe("Just", Data$dGeneric$dRep.Product($0._1)); }
        return Data$dMaybe.Nothing;
      })())(dictGenericBoundedEnum1["genericToEnum'"](Data$dEuclideanRing.intMod(n)(genericCardinality$p2))),
