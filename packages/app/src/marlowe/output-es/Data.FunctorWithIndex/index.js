...
const functorWithIndexMaybe = {mapWithIndex: f => Data$dMaybe.functorMaybe.map(f()), Functor0: () => Data$dMaybe.functorMaybe};
const functorWithIndexLast = {mapWithIndex: f => Data$dMaybe.functorMaybe.map(f()), Functor0: () => Data$dMaybe.functorMaybe};
const functorWithIndexIdentity = {mapWithIndex: f => v => f()(v), Functor0: () => Data$dIdentity.functorIdentity};
const functorWithIndexFirst = {mapWithIndex: f => Data$dMaybe.functorMaybe.map(f()), Functor0: () => Data$dMaybe.functorMaybe};
