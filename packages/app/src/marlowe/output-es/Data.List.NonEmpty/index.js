...
const takeWhile = x => {
  const $0 = Data$dList.takeWhile(x);
  return v => $0(Data$dList$dTypes.$List("Cons", v._1, v._2));
};
const length = v => {
...
const findIndex = f => v => {
  if (f(v._1)) { return Data$dMaybe.$Maybe("Just", 0); }
  const $0 = Data$dList.findIndex(f)(v._2);
...
const catMaybes = v => Data$dList.catMaybes(Data$dList$dTypes.$List("Cons", v._1, v._2));
