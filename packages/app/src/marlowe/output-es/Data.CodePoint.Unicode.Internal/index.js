...
const $UnicodeCategory = tag => tag;
const NUMCAT_LU = /* #__PURE__ */ $UnicodeCategory("NUMCAT_LU");
const NUMCAT_LL = /* #__PURE__ */ $UnicodeCategory("NUMCAT_LL");
const NUMCAT_LT = /* #__PURE__ */ $UnicodeCategory("NUMCAT_LT");
const NUMCAT_LM = /* #__PURE__ */ $UnicodeCategory("NUMCAT_LM");
const NUMCAT_LO = /* #__PURE__ */ $UnicodeCategory("NUMCAT_LO");
const NUMCAT_MN = /* #__PURE__ */ $UnicodeCategory("NUMCAT_MN");
const NUMCAT_MC = /* #__PURE__ */ $UnicodeCategory("NUMCAT_MC");
const NUMCAT_ME = /* #__PURE__ */ $UnicodeCategory("NUMCAT_ME");
const NUMCAT_ND = /* #__PURE__ */ $UnicodeCategory("NUMCAT_ND");
const NUMCAT_NL = /* #__PURE__ */ $UnicodeCategory("NUMCAT_NL");
const NUMCAT_NO = /* #__PURE__ */ $UnicodeCategory("NUMCAT_NO");
const NUMCAT_PC = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PC");
const NUMCAT_PD = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PD");
const NUMCAT_PS = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PS");
const NUMCAT_PE = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PE");
const NUMCAT_PI = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PI");
const NUMCAT_PF = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PF");
const NUMCAT_PO = /* #__PURE__ */ $UnicodeCategory("NUMCAT_PO");
const NUMCAT_SM = /* #__PURE__ */ $UnicodeCategory("NUMCAT_SM");
const NUMCAT_SC = /* #__PURE__ */ $UnicodeCategory("NUMCAT_SC");
const NUMCAT_SK = /* #__PURE__ */ $UnicodeCategory("NUMCAT_SK");
const NUMCAT_SO = /* #__PURE__ */ $UnicodeCategory("NUMCAT_SO");
const NUMCAT_ZS = /* #__PURE__ */ $UnicodeCategory("NUMCAT_ZS");
const NUMCAT_ZL = /* #__PURE__ */ $UnicodeCategory("NUMCAT_ZL");
const NUMCAT_ZP = /* #__PURE__ */ $UnicodeCategory("NUMCAT_ZP");
const NUMCAT_CC = /* #__PURE__ */ $UnicodeCategory("NUMCAT_CC");
const NUMCAT_CF = /* #__PURE__ */ $UnicodeCategory("NUMCAT_CF");
const NUMCAT_CS = /* #__PURE__ */ $UnicodeCategory("NUMCAT_CS");
const NUMCAT_CO = /* #__PURE__ */ $UnicodeCategory("NUMCAT_CO");
const NUMCAT_CN = /* #__PURE__ */ $UnicodeCategory("NUMCAT_CN");
const ConversionRule = x => x;
const CharBlock = x => x;
const showUnicodeCategory = {
  show: v => {
    if (v === "NUMCAT_LU") { return "NUMCAT_LU"; }
    if (v === "NUMCAT_LL") { return "NUMCAT_LL"; }
    if (v === "NUMCAT_LT") { return "NUMCAT_LT"; }
    if (v === "NUMCAT_LM") { return "NUMCAT_LM"; }
    if (v === "NUMCAT_LO") { return "NUMCAT_LO"; }
    if (v === "NUMCAT_MN") { return "NUMCAT_MN"; }
    if (v === "NUMCAT_MC") { return "NUMCAT_MC"; }
    if (v === "NUMCAT_ME") { return "NUMCAT_ME"; }
    if (v === "NUMCAT_ND") { return "NUMCAT_ND"; }
    if (v === "NUMCAT_NL") { return "NUMCAT_NL"; }
    if (v === "NUMCAT_NO") { return "NUMCAT_NO"; }
    if (v === "NUMCAT_PC") { return "NUMCAT_PC"; }
    if (v === "NUMCAT_PD") { return "NUMCAT_PD"; }
    if (v === "NUMCAT_PS") { return "NUMCAT_PS"; }
    if (v === "NUMCAT_PE") { return "NUMCAT_PE"; }
    if (v === "NUMCAT_PI") { return "NUMCAT_PI"; }
    if (v === "NUMCAT_PF") { return "NUMCAT_PF"; }
    if (v === "NUMCAT_PO") { return "NUMCAT_PO"; }
    if (v === "NUMCAT_SM") { return "NUMCAT_SM"; }
    if (v === "NUMCAT_SC") { return "NUMCAT_SC"; }
    if (v === "NUMCAT_SK") { return "NUMCAT_SK"; }
    if (v === "NUMCAT_SO") { return "NUMCAT_SO"; }
    if (v === "NUMCAT_ZS") { return "NUMCAT_ZS"; }
    if (v === "NUMCAT_ZL") { return "NUMCAT_ZL"; }
    if (v === "NUMCAT_ZP") { return "NUMCAT_ZP"; }
    if (v === "NUMCAT_CC") { return "NUMCAT_CC"; }
    if (v === "NUMCAT_CF") { return "NUMCAT_CF"; }
    if (v === "NUMCAT_CS") { return "NUMCAT_CS"; }
    if (v === "NUMCAT_CO") { return "NUMCAT_CO"; }
    if (v === "NUMCAT_CN") { return "NUMCAT_CN"; }
    $runtime.fail();
  }
};
const showConversionRule = {
  show: v => "ConversionRule { category: " + Data$dShow.showIntImpl(v.category) + ", unicodeCat: " + showUnicodeCategory.show(v.unicodeCat) + ", possible: " + Data$dShow.showIntImpl(v.possible) + ", updist: " + Data$dShow.showIntImpl(v.updist) + ", lowdist: " + Data$dShow.showIntImpl(v.lowdist) + ", titledist: " + Data$dShow.showIntImpl(v.titledist) + " }"
};
const showCharBlock = {
  show: v => "CharBlock { start: " + Data$dShow.showIntImpl(v.start) + ", length: " + Data$dShow.showIntImpl(v.length) + ", convRule: " + showConversionRule.show(v.convRule) + " }"
};
const numSpaceBlocks = 7;
const numRules = 205;
const numLat1Blocks = 63;
const numConvBlocks = 1332;
const numBlocks = 3396;
const maxUniChar = 1114109;
const gencatZS = 2;
const rule1 = {category: 2, unicodeCat: NUMCAT_ZS, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const spacechars = [
...
const rule162 = {category: 67108864, unicodeCat: NUMCAT_ZP, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatZL = 33554432;
const rule161 = {category: 33554432, unicodeCat: NUMCAT_ZL, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatSO = 8192;
const rule13 = {category: 8192, unicodeCat: NUMCAT_SO, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule170 = {category: 8192, unicodeCat: NUMCAT_SO, possible: 1, updist: 0, lowdist: 26, titledist: 0};
const rule171 = {category: 8192, unicodeCat: NUMCAT_SO, possible: 1, updist: -26, lowdist: 0, titledist: -26};
const gencatSM = 64;
const rule6 = {category: 64, unicodeCat: NUMCAT_SM, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatSK = 1024;
const rule10 = {category: 1024, unicodeCat: NUMCAT_SK, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatSC = 8;
const rule3 = {category: 8, unicodeCat: NUMCAT_SC, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPS = 16;
const rule4 = {category: 16, unicodeCat: NUMCAT_PS, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPO = 4;
const rule2 = {category: 4, unicodeCat: NUMCAT_PO, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPI = 32768;
const rule15 = {category: 32768, unicodeCat: NUMCAT_PI, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPF = 262144;
const rule19 = {category: 262144, unicodeCat: NUMCAT_PF, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPE = 32;
const rule5 = {category: 32, unicodeCat: NUMCAT_PE, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPD = 128;
const rule7 = {category: 128, unicodeCat: NUMCAT_PD, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatPC = 2048;
const rule11 = {category: 2048, unicodeCat: NUMCAT_PC, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatNO = 131072;
const rule17 = {category: 131072, unicodeCat: NUMCAT_NO, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatNL = 16777216;
const rule128 = {category: 16777216, unicodeCat: NUMCAT_NL, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule168 = {category: 16777216, unicodeCat: NUMCAT_NL, possible: 1, updist: 0, lowdist: 16, titledist: 0};
const rule169 = {category: 16777216, unicodeCat: NUMCAT_NL, possible: 1, updist: -16, lowdist: 0, titledist: -16};
const gencatND = 256;
const rule8 = {category: 256, unicodeCat: NUMCAT_ND, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatMN = 2097152;
const rule92 = {category: 2097152, unicodeCat: NUMCAT_MN, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule93 = {category: 2097152, unicodeCat: NUMCAT_MN, possible: 1, updist: 84, lowdist: 0, titledist: 84};
const gencatME = 4194304;
const rule119 = {category: 4194304, unicodeCat: NUMCAT_ME, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatMC = 8388608;
const rule124 = {category: 8388608, unicodeCat: NUMCAT_MC, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatLU = 512;
const nullrule = {category: 512, unicodeCat: NUMCAT_CN, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule104 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 8, titledist: 0};
const rule107 = {category: 512, unicodeCat: NUMCAT_LU, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule115 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -60, titledist: 0};
const rule117 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -7, titledist: 0};
const rule118 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 80, titledist: 0};
const rule120 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 15, titledist: 0};
const rule122 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 48, titledist: 0};
const rule125 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 7264, titledist: 0};
const rule127 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 38864, titledist: 0};
const rule137 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -3008, titledist: 0};
const rule142 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -7615, titledist: 0};
const rule144 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -8, titledist: 0};
const rule153 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -74, titledist: 0};
const rule156 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -86, titledist: 0};
const rule157 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -100, titledist: 0};
const rule158 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -112, titledist: 0};
const rule159 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -128, titledist: 0};
const rule160 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -126, titledist: 0};
const rule163 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -7517, titledist: 0};
const rule164 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -8383, titledist: 0};
const rule165 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -8262, titledist: 0};
const rule166 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 28, titledist: 0};
const rule172 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10743, titledist: 0};
const rule173 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -3814, titledist: 0};
const rule174 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10727, titledist: 0};
const rule177 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10780, titledist: 0};
const rule178 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10749, titledist: 0};
const rule179 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10783, titledist: 0};
const rule180 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10782, titledist: 0};
const rule181 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -10815, titledist: 0};
const rule183 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -35332, titledist: 0};
const rule184 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42280, titledist: 0};
const rule186 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42308, titledist: 0};
const rule187 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42319, titledist: 0};
const rule188 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42315, titledist: 0};
const rule189 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42305, titledist: 0};
const rule190 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42258, titledist: 0};
const rule191 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42282, titledist: 0};
const rule192 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42261, titledist: 0};
const rule193 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 928, titledist: 0};
const rule194 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -48, titledist: 0};
const rule195 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -42307, titledist: 0};
const rule196 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -35384, titledist: 0};
const rule201 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 40, titledist: 0};
const rule203 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 34, titledist: 0};
const rule22 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 1, titledist: 0};
const rule24 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -199, titledist: 0};
const rule26 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -121, titledist: 0};
const rule29 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 210, titledist: 0};
const rule30 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 206, titledist: 0};
const rule31 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 205, titledist: 0};
const rule32 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 79, titledist: 0};
const rule33 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 202, titledist: 0};
const rule34 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 203, titledist: 0};
const rule35 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 207, titledist: 0};
const rule37 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 211, titledist: 0};
const rule38 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 209, titledist: 0};
const rule40 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 213, titledist: 0};
const rule42 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 214, titledist: 0};
const rule43 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 218, titledist: 0};
const rule44 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 217, titledist: 0};
const rule45 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 219, titledist: 0};
const rule47 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 2, titledist: 1};
const rule51 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -97, titledist: 0};
const rule52 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -56, titledist: 0};
const rule53 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -130, titledist: 0};
const rule54 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 10795, titledist: 0};
const rule55 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -163, titledist: 0};
const rule56 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 10792, titledist: 0};
const rule58 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: -195, titledist: 0};
const rule59 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 69, titledist: 0};
const rule60 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 71, titledist: 0};
const rule9 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 32, titledist: 0};
const rule94 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 116, titledist: 0};
const rule95 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 38, titledist: 0};
const rule96 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 37, titledist: 0};
const rule97 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 64, titledist: 0};
const rule98 = {category: 512, unicodeCat: NUMCAT_LU, possible: 1, updist: 0, lowdist: 63, titledist: 0};
const gencatLT = 524288;
const rule151 = {category: 524288, unicodeCat: NUMCAT_LT, possible: 1, updist: 0, lowdist: -8, titledist: 0};
const rule154 = {category: 524288, unicodeCat: NUMCAT_LT, possible: 1, updist: 0, lowdist: -9, titledist: 0};
const rule48 = {category: 524288, unicodeCat: NUMCAT_LT, possible: 1, updist: -1, lowdist: 1, titledist: 0};
const gencatLO = 16384;
const rule14 = {category: 16384, unicodeCat: NUMCAT_LO, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatLM = 1048576;
const rule91 = {category: 1048576, unicodeCat: NUMCAT_LM, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatLL = 4096;
const rule100 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -37, lowdist: 0, titledist: -37};
const rule101 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -31, lowdist: 0, titledist: -31};
const rule102 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -64, lowdist: 0, titledist: -64};
const rule103 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -63, lowdist: 0, titledist: -63};
const rule105 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -62, lowdist: 0, titledist: -62};
const rule106 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -57, lowdist: 0, titledist: -57};
const rule108 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -47, lowdist: 0, titledist: -47};
const rule109 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -54, lowdist: 0, titledist: -54};
const rule110 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -8, lowdist: 0, titledist: -8};
const rule111 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -86, lowdist: 0, titledist: -86};
const rule112 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -80, lowdist: 0, titledist: -80};
const rule113 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 7, lowdist: 0, titledist: 7};
const rule114 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -116, lowdist: 0, titledist: -116};
const rule116 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -96, lowdist: 0, titledist: -96};
const rule12 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -32, lowdist: 0, titledist: -32};
const rule121 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -15, lowdist: 0, titledist: -15};
const rule123 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -48, lowdist: 0, titledist: -48};
const rule126 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 3008, lowdist: 0, titledist: 0};
const rule129 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6254, lowdist: 0, titledist: -6254};
const rule130 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6253, lowdist: 0, titledist: -6253};
const rule131 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6244, lowdist: 0, titledist: -6244};
const rule132 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6242, lowdist: 0, titledist: -6242};
const rule133 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6243, lowdist: 0, titledist: -6243};
const rule134 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6236, lowdist: 0, titledist: -6236};
const rule135 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -6181, lowdist: 0, titledist: -6181};
const rule136 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 35266, lowdist: 0, titledist: 35266};
const rule138 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 35332, lowdist: 0, titledist: 35332};
const rule139 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 3814, lowdist: 0, titledist: 3814};
const rule140 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 35384, lowdist: 0, titledist: 35384};
const rule141 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -59, lowdist: 0, titledist: -59};
const rule143 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 8, lowdist: 0, titledist: 8};
const rule145 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 74, lowdist: 0, titledist: 74};
const rule146 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 86, lowdist: 0, titledist: 86};
const rule147 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 100, lowdist: 0, titledist: 100};
const rule148 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 128, lowdist: 0, titledist: 128};
const rule149 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 112, lowdist: 0, titledist: 112};
const rule150 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 126, lowdist: 0, titledist: 126};
const rule152 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 9, lowdist: 0, titledist: 9};
const rule155 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -7205, lowdist: 0, titledist: -7205};
const rule167 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -28, lowdist: 0, titledist: -28};
const rule175 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -10795, lowdist: 0, titledist: -10795};
const rule176 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -10792, lowdist: 0, titledist: -10792};
const rule18 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 743, lowdist: 0, titledist: 743};
const rule182 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -7264, lowdist: 0, titledist: -7264};
const rule185 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 48, lowdist: 0, titledist: 48};
const rule197 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -928, lowdist: 0, titledist: -928};
const rule198 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -38864, lowdist: 0, titledist: -38864};
const rule20 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const rule202 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -40, lowdist: 0, titledist: -40};
const rule204 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -34, lowdist: 0, titledist: -34};
const rule21 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 121, lowdist: 0, titledist: 121};
const rule23 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -1, lowdist: 0, titledist: -1};
const rule25 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -232, lowdist: 0, titledist: -232};
const rule27 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -300, lowdist: 0, titledist: -300};
const rule28 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 195, lowdist: 0, titledist: 195};
const rule36 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 97, lowdist: 0, titledist: 97};
const rule39 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 163, lowdist: 0, titledist: 163};
const rule41 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 130, lowdist: 0, titledist: 130};
const rule46 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 56, lowdist: 0, titledist: 56};
const rule49 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -2, lowdist: 0, titledist: -1};
const rule50 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -79, lowdist: 0, titledist: -79};
const rule57 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10815, lowdist: 0, titledist: 10815};
const rule61 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10783, lowdist: 0, titledist: 10783};
const rule62 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10780, lowdist: 0, titledist: 10780};
const rule63 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10782, lowdist: 0, titledist: 10782};
const rule64 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -210, lowdist: 0, titledist: -210};
const rule65 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -206, lowdist: 0, titledist: -206};
const rule66 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -205, lowdist: 0, titledist: -205};
const rule67 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -202, lowdist: 0, titledist: -202};
const rule68 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -203, lowdist: 0, titledist: -203};
const rule69 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42319, lowdist: 0, titledist: 42319};
const rule70 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42315, lowdist: 0, titledist: 42315};
const rule71 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -207, lowdist: 0, titledist: -207};
const rule72 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42280, lowdist: 0, titledist: 42280};
const rule73 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42308, lowdist: 0, titledist: 42308};
const rule74 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -209, lowdist: 0, titledist: -209};
const rule75 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -211, lowdist: 0, titledist: -211};
const rule76 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10743, lowdist: 0, titledist: 10743};
const rule77 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42305, lowdist: 0, titledist: 42305};
const rule78 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10749, lowdist: 0, titledist: 10749};
const rule79 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -213, lowdist: 0, titledist: -213};
const rule80 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -214, lowdist: 0, titledist: -214};
const rule81 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 10727, lowdist: 0, titledist: 10727};
const rule82 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -218, lowdist: 0, titledist: -218};
const rule83 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42307, lowdist: 0, titledist: 42307};
const rule84 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42282, lowdist: 0, titledist: 42282};
const rule85 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -69, lowdist: 0, titledist: -69};
const rule86 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -217, lowdist: 0, titledist: -217};
const rule87 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -71, lowdist: 0, titledist: -71};
const rule88 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -219, lowdist: 0, titledist: -219};
const rule89 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42261, lowdist: 0, titledist: 42261};
const rule90 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: 42258, lowdist: 0, titledist: 42258};
const rule99 = {category: 4096, unicodeCat: NUMCAT_LL, possible: 1, updist: -38, lowdist: 0, titledist: -38};
const gencatCS = 134217728;
const rule199 = {category: 134217728, unicodeCat: NUMCAT_CS, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatCO = 268435456;
const rule200 = {category: 268435456, unicodeCat: NUMCAT_CO, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatCF = 65536;
const rule16 = {category: 65536, unicodeCat: NUMCAT_CF, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const gencatCC = 1;
const rule0 = {category: 1, unicodeCat: NUMCAT_CC, possible: 0, updist: 0, lowdist: 0, titledist: 0};
const convchars = [
  ...
  {start: 1000, length: 1, convRule: rule22},
  ...
  {start: 8000, length: 6, convRule: rule143},
...
const bsearch = a => array => size => compare => {
  const go = go$a0$copy => go$a1$copy => {
    ...
    while (go$c) {
      ...
      const j = Data$dInt.unsafeClamp(Data$dNumber.floor(Data$dInt.toNumber(i + k | 0) / 2.0));
      const b = array[j];
      const v = compare(a)(b);
      if (v === "EQ") {
        go$c = false;
        go$r = Data$dMaybe.$Maybe("Just", b);
        continue;
      }
      if (v === "GT") {
        go$a0 = j + 1 | 0;
...
const blkCmp = v => v1 => {
  if (v.start >= v1.start && v.start < (v1.start + v1.length | 0)) { return Data$dOrdering.EQ; }
  if (v.start > v1.start) { return Data$dOrdering.GT; }
  return Data$dOrdering.LT;
};
const getRule = blocks => unichar => size => {
  const maybeCharBlock = bsearch({start: unichar, length: 1, convRule: nullrule})(blocks)(size)(blkCmp);
  if (maybeCharBlock.tag === "Nothing") { return Data$dMaybe.Nothing; }
  if (maybeCharBlock.tag === "Just") { return Data$dMaybe.$Maybe("Just", maybeCharBlock._1.convRule); }
  $runtime.fail();
};
const caseConv = f => $$char => {
  const maybeConversionRule = getRule(convchars)($$char)(1332);
  if (maybeConversionRule.tag === "Nothing") { return $$char; }
  if (maybeConversionRule.tag === "Just") { return $$char + f(maybeConversionRule._1) | 0; }
  $runtime.fail();
};
const uTowlower = /* #__PURE__ */ caseConv(v => v.lowdist);
const uTowtitle = /* #__PURE__ */ caseConv(v => v.titledist);
const uTowupper = /* #__PURE__ */ caseConv(v => v.updist);
const checkAttrS = categories => $$char => {
  const maybeConversionRule = getRule(spacechars)($$char)(7);
  if (maybeConversionRule.tag === "Nothing") { return false; }
  if (maybeConversionRule.tag === "Just") {
    const $0 = maybeConversionRule._1.category;
    const $1 = Data$dArray.findIndex(v => v === $0)(categories);
    if ($1.tag === "Nothing") { return false; }
    if ($1.tag === "Just") { return true; }
  }
  $runtime.fail();
};
const uIswspace = /* #__PURE__ */ checkAttrS([2]);
const allchars = [
  ...
  {start: 43000, length: 2, convRule: rule91},
  ...
  {start: 72000, length: 1, convRule: rule124},
  ...
  {start: 128000, length: 728, convRule: rule13},
...
const checkAttr = categories => $$char => {
...
const uIswalnum = /* #__PURE__ */ checkAttr([524288, 512, 4096, 1048576, 16384, 8388608, 4194304, 2097152, 131072, 256, 16777216]);
const uIswalpha = /* #__PURE__ */ checkAttr([4096, 512, 524288, 1048576, 16384]);
const uIswcntrl = /* #__PURE__ */ checkAttr([1]);
const uIswdigit = /* #__PURE__ */ checkAttr([256]);
const uIswlower = /* #__PURE__ */ checkAttr([4096]);
const uIswprint = /* #__PURE__ */ checkAttr([
  8388608,
  131072,
  1024,
  4194304,
...
const uIswupper = /* #__PURE__ */ checkAttr([512, 524288]);
const uGencat = $$char => {
  const $0 = getRule(allchars)($$char)(3396);
  if ($0.tag === "Just") { return Data$dMaybe.$Maybe("Just", $0._1.unicodeCat); }
