...
const millisToTime = v => {
  ...
  const $0 = Data$dMaybe.applyMaybe.apply(Data$dMaybe.applyMaybe.apply(Data$dMaybe.applyMaybe.apply((() => {
    const $0 = Data$dInt.unsafeClamp(Data$dNumber.floor(hours));
    if ($0 >= 0 && $0 <= 23) { return Data$dMaybe.$Maybe("Just", Time($0)); }
    return Data$dMaybe.Nothing;
  })())((() => {
    const $0 = Data$dInt.unsafeClamp(Data$dNumber.floor(minutes));
    if ($0 >= 0 && $0 <= 59) { return Data$dMaybe.$Maybe("Just", $0); }
    return Data$dMaybe.Nothing;
  })()))((() => {
    const $0 = Data$dInt.unsafeClamp(Data$dNumber.floor(seconds));
    if ($0 >= 0 && $0 <= 59) { return Data$dMaybe.$Maybe("Just", $0); }
    return Data$dMaybe.Nothing;
  })()))((() => {
    const $0 = Data$dInt.unsafeClamp(Data$dNumber.floor(v - (hours * 3600000.0 + minutes * 60000.0 + seconds * 1000.0)));
