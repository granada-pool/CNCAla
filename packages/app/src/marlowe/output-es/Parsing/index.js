...
const semigroupParserT = dictSemigroup => (
  {
    append: a => b => (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => a(
      ...
      (state2, a$1) => more(v2$1 => {
        ...
        return more(v3 => b(state2, more, lift1, $$throw, (state3, a$2) => more(v4 => done(state3, $0(a$2)))));
      })
    )))
  }
);
  ...
  const semigroupParserT1 = {
    append: a => b => (state1, more, lift1, $$throw, done) => more(v2 => more(v1 => a(
      ...
      (state2, a$1) => more(v2$1 => {
        ...
        return more(v3 => b(state2, more, lift1, $$throw, (state3, a$2) => more(v4 => done(state3, $1(a$2)))));
      })
    )))
  };
  return {
...
const fail = message => (state1, more, lift1, $$throw, done) => more(v1 => position(
  ...
  lift1,
  $$throw,
  (state2, a) => more(v2 => $$throw(state2, $ParseError(message, a)))
));
...
const liftExceptT = dictMonad => f => (state1, more, lift1, $$throw, done) => more(v1 => lift1(dictMonad.Bind1().Apply0().Functor0().map(a => v2 => more(v2$1 => {
  if (a.tag === "Left") { return fail(a._1)(state1, more, lift1, $$throw, done); }
  if (a.tag === "Right") { return done(state1, a._1); }
  $runtime.fail();
}))(f)));
