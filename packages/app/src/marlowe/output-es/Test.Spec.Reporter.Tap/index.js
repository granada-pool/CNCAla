...
const escTitle = /* #__PURE__ */ Data$dString$dRegex.replace(/* #__PURE__ */ (() => {
  const $0 = Data$dString$dRegex.regex("#")(Data$dString$dRegex.parseFlags("g"));
  if ($0.tag === "Left") { $runtime.fail(); }
  if ($0.tag === "Right") { return $0._1; }
  $runtime.fail();
})())("");
const escMsg = /* #__PURE__ */ Data$dString$dRegex.replace(/* #__PURE__ */ (() => {
  const $0 = Data$dString$dRegex.regex("^")(Data$dString$dRegex.parseFlags("gm"));
  if ($0.tag === "Left") { $runtime.fail(); }
  if ($0.tag === "Right") { return $0._1; }
  $runtime.fail();
})())("  ");
