...
const readyState = el => () => {
  ...
  return (() => {
    const $0 = Web$dHTML$dHTMLMediaElement$dReadyState.toEnumReadyState(a$p);
    if ($0.tag === "Nothing") { return Web$dHTML$dHTMLMediaElement$dReadyState.HaveNothing; }
...
const networkState = el => () => {
  ...
  return (() => {
    const $0 = Web$dHTML$dHTMLMediaElement$dNetworkState.toEnumNetworkState(a$p);
    if ($0.tag === "Nothing") { return Web$dHTML$dHTMLMediaElement$dNetworkState.Empty; }
    if ($0.tag === "Just") { return $0._1; }
    $runtime.fail();
  })();
};
...
const canPlayType = ty => el => () => {
  ...
  return (() => {
    const $0 = Web$dHTML$dHTMLMediaElement$dCanPlayType.parse(a$p);
    if ($0.tag === "Nothing") { return Web$dHTML$dHTMLMediaElement$dCanPlayType.Unspecified; }
    if ($0.tag === "Just") { return $0._1; }
    $runtime.fail();
  })();
};
